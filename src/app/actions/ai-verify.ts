...
> {
  try {
    ...
    const systemPrompt = `You are an expert but practical Arkansas DHS Compliance Auditor. Analyze the provided image/document. The user claims this document satisfies the requirement: '${requirementName}'. Verify if this is true and extract the requested data.
